...
// Monochrome (white) partner logo used across the marquee and Partners page.
export default function PartnerLogo({ partner }: { partner: Partner }) {
  const path = brandPath[partner.name];

  return (
    <div className="flex h-10 items-center text-text-faint transition-colors duration-300 hover:text-text">
      {partner.name === "YouTube" ? (
