...
const VARIANTS: Record<AuroraVariant, [string, string, string][]> = {
  ...
  // Brand: muted, bronze-weighted tones across the gold family.
  gold: [
    ["hsla(38, 78%, 46%, 0.28)", "hsla(32, 74%, 40%, 0.16)", "transparent"], // muted gold
    ["hsla(30, 78%, 40%, 0.3)", "hsla(26, 74%, 36%, 0.16)", "transparent"], // amber
    ["hsla(24, 76%, 35%, 0.34)", "hsla(20, 72%, 30%, 0.18)", "transparent"], // bronze
    ["hsla(20, 74%, 30%, 0.36)", "transparent", "transparent"], // deep copper
    ["hsla(44, 70%, 56%, 0.16)", "transparent", "transparent"], // faint champagne highlight
    ["hsla(22, 76%, 32%, 0.32)", "transparent", "transparent"], // more copper
  ],
};
